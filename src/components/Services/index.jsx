          ...
          <ul className="services-section-list">
            <li data-aos="fade-up" className="services-section-item">
              <svg
                ...
                role="presentation"
                aria-hidden="true"
                aria-labelledby="svgcid-bg4vslbz0lc0"
              >
                <defs>
                  <style>#comp-kq5dfsen svg </style>
                </defs>
                <title id="svgcid-bg4vslbz0lc0"></title>
                <g>
                  <path
                    fill="#16163F"
                    clip-rule="evenodd"
            ...
            <li data-aos="fade-up" className="services-section-item">
              <svg
                ...
                role="presentation"
                aria-hidden="true"
                aria-labelledby="svgcid-jk4aukv1lt1t"
              >
                <defs>
                  <style>#comp-kq9ag33l svg </style>
                </defs>
                <title id="svgcid-jk4aukv1lt1t"></title>
                <g>
                  <path
                    clip-rule="evenodd"
                    fill-rule="evenodd"
            ...
            <li data-aos="fade-up" className="services-section-item">
              <svg
                ...
                role="presentation"
                aria-hidden="true"
                aria-labelledby="svgcid-d30onx-rpuifd"
              >
                <defs>
                  <style>#comp-kq5dfsf71 svg </style>
                </defs>
                <title id="svgcid-d30onx-rpuifd"></title>
                <g>
                  <path
                    fill="#16163F"
                    clip-rule="evenodd"
